 ...
 */
final class Version20250212125904 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movies (imdb_id VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, year INT NOT NULL, poster VARCHAR(255) NOT NULL, type VARCHAR(7) NOT NULL, PRIMARY KEY(imdb_id, username, title))');
